...
def update_readme(summary):
    ...
    with open('pertemuan3/README.md', 'r', encoding='utf-8') as f:
    ...
    with open('pertemuan3/README.md', 'w', encoding='utf-8') as f:
        f.writelines(updated_content)

if __name__ == "__main__":
    post_link = "https://medium.com/@dikaelsaputra/netbeans-praktik-dasar-java-kelas-dan-objek-58e1f14e832a?source=rss-272e0aace4a6------2"
